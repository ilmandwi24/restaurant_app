...
void main() {
  ...
  test('fetchRestaurantList sets state to loading, then loaded on success', () async {
      final restaurants = [
        Restaurant(
      ...
      test('fetchRestaurantList sets state to loading, then error on failure', () async {
      // Arrange
      ...
      expect(
        ...
        equals('Exception: Failed to load'),
      );
    });
